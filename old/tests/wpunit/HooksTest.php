...
namespace DeepWebSolutions\Framework\tests\wpunit;

use Codeception\TestCase\WPTestCase;
use DeepWebSolutions\Framework\Helpers\Hooks;
use DeepWebSolutions\Framework\tests\_support\WpunitTester;
use DeepWebSolutions\Framework\Tests\Helpers\Integration\plugin;
use function DeepWebSolutions\Framework\Tests\Helpers\Integration\add_action;
use function DeepWebSolutions\Framework\Tests\Helpers\Integration\add_filter;
use function DeepWebSolutions\Framework\Tests\Helpers\Integration\apply_filters;
use function DeepWebSolutions\Framework\Tests\Helpers\Integration\do_action;
...
class HooksTest extends WPTestCase {
	...
	public function test_get_hook_tag_function_trait( array $example ) {
		$hooks = new plugin\src\includes\Hooks();
